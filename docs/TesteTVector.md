...
┌─ ☰ Menu ─────────┬────────────────┬─────────────────────┬──────────────┐
│ 1 <span class="icon">📄</span>   <span style="color:gray">Instância</span>  │ 2 <span class="icon">🔍</span>  <span style="color:gray">Explorar</span> │ 3 <span class="icon">⚙</span>   <span style="color:gray">Parâmetros</span>    │ 4 <span class="icon">✔</span>  <span style="color:gray">Solução</span> │
│ 5 <span class="icon">⚖</span>   <span style="color:gray">Indicadores</span> │ 6 <span class="icon">►</span>   <span style="color:gray">Executar</span> │ 7 <span class="icon">🛠️</span>  <span style="color:gray">Configurações</span> │ 8 <span class="icon">🧪</span>  <span style="color:gray">Teste</span>  │
└───────────────────┴────────────────┴─────────────────────┴──────────────┘
Opção: 
</pre>
\endhtmlonly
