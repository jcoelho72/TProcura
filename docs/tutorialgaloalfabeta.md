...
<p>Na expansão do estado 2, o valor de alfa mantém-se a 1, sendo gerado o estado
...
<p>A estratégia calcula-se da mesma forma, neste caso é 1,4,5, tendo que se ter
  ...
  que têm o seu valor correto, os restantes podem ter o valor incorreto devido
  ...
  valor do estado 2 pode não ser o correto. Na realidade sabemos que não é
  realmente o correto, do exemplo anterior o valor desse estado seria -1.</p>
<hr>
<details>
