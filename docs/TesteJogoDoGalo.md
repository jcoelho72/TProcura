...
│ P8(ESTADOS_REPETIDOS): ignorar | P11(BARALHAR_SUCESSORES): 0 | P12(ORDENAR_SUCESSORES): 2
│ P13(PODA_HEURISTICA): 0 | P14(PODA_CEGA): 0
└──────────────────────────────────────────────────────────────────────
 │   A B C
 │ 1 . . . 1
 │ 2 . . . 2
...
═╤═ ►  Execução iniciada ═══
 ...
 │      A B C
 │    🍃 0
 ├─ ⚙️  Parâmetros ─ P1=1 P2=4 P3=1 P4=10 P5=0 P6=1 P7=2 P8=1 P11=0 P12=0 P13=0 P14=0
═╧═ 🏁  Execução terminada ⏱  1ms  ═══
Jogo do Galo
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
│ P1(ALGORITMO): MiniMax | P2(NIVEL_DEBUG): COMPLETO | P3(SEMENTE): 1 | P4(LIMITE_TEMPO): 10
│ P5(LIMITE_ITERACOES): 0 | P6(VER_ACOES): 1 | P7(LIMITE): 2 | P8(ESTADOS_REPETIDOS): ignorar
...
└──────────────────────────────────────────────────────────────────────
 ...
 │   A B C
┌─ ⚖  Indicadores ─────────────────────────────────────────────────────
│ I1(IND_CUSTO): 0 | I2(Tempo(ms)): 1 | I3(Iterações): 9 | I4(IND_EXPANSOES): 1 |
│ I5(IND_GERACOES): 9 | I6(IND_LOWER_BOUND): 0
└──────────────────────────────────────────────────────────────────────
...
Opção:
</pre>
...
═╤═ ►  Execução iniciada ═══ HT: reutilização 1.67 vezes
 ...
 │      A B C
 │    💾 0
 ├─ ⚙️  Parâmetros ─ P1=1 P2=4 P3=1 P4=10 P5=0 P6=1 P7=2 P8=1 P11=0 P12=2 P13=0 P14=0
═╧═ 🏁  Execução terminada ⏱  6ms  ═══
Jogo do Galo
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
│ P1(ALGORITMO): MiniMax | P2(NIVEL_DEBUG): COMPLETO | P3(SEMENTE): 1 | P4(LIMITE_TEMPO): 10
│ P5(LIMITE_ITERACOES): 0 | P6(VER_ACOES): 1 | P7(LIMITE): 2 | P8(ESTADOS_REPETIDOS): ignorar
│ P11(BARALHAR_SUCESSORES): 0 | P12(ORDENAR_SUCESSORES): 2 | P13(PODA_HEURISTICA): 0
│ P14(PODA_CEGA): 0
└──────────────────────────────────────────────────────────────────────
 │   A B C
 │ 1 x . . 1
 ...
 │   A B C
┌─ ⚖  Indicadores ─────────────────────────────────────────────────────
│ I1(IND_CUSTO): 0 | I2(Tempo(ms)): 6 | I3(Iterações): 3 | I4(IND_EXPANSOES): 1 |
│ I5(IND_GERACOES): 9 | I6(IND_LOWER_BOUND): 0
└──────────────────────────────────────────────────────────────────────
...
Opção:
...
═╤═ ►  Execução iniciada ═══ HT: reutilização 1.69 vezes
 ...
 │  └□═╤═ 🔖1 💰 g:1 🔢 6|43|32 ═══ ⚡b1
 │    💾 0
 ├─ ⚙️  Parâmetros ─ P1=1 P2=3 P3=1 P4=10 P5=0 P6=4 P7=3 P8=1 P11=0 P12=2 P13=0 P14=0
═╧═ 🏁  Execução terminada ⏱  4ms  ═══
Jogo do Galo
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
│ P1(ALGORITMO): MiniMax | P2(NIVEL_DEBUG): DETALHE | P3(SEMENTE): 1 | P4(LIMITE_TEMPO): 10
│ P5(LIMITE_ITERACOES): 0 | P6(VER_ACOES): 4 | P7(LIMITE): 3 | P8(ESTADOS_REPETIDOS): ignorar
│ P11(BARALHAR_SUCESSORES): 0 | P12(ORDENAR_SUCESSORES): 2 | P13(PODA_HEURISTICA): 0
│ P14(PODA_CEGA): 0
└──────────────────────────────────────────────────────────────────────
 │   A B C
 ...
 │   A B C
┌─ ⚖  Indicadores ─────────────────────────────────────────────────────
│ I1(IND_CUSTO): 0 | I2(Tempo(ms)): 4 | I3(Iterações): 32 | I4(IND_EXPANSOES): 6 |
│ I5(IND_GERACOES): 43 | I6(IND_LOWER_BOUND): 0
└──────────────────────────────────────────────────────────────────────
...
Opção:
</pre>
...
═╤═ ►  Execução iniciada ═══ HT: reutilização 0.35 vezes
 ...
 │     ├□ 998
 │     └─ ☗ 1 { 🔖25 }
 ├─ ⚙️  Parâmetros ─ P1=1 P2=4 P3=1 P4=10 P5=0 P6=4 P7=3 P8=1 P11=0 P12=2 P13=0 P14=0
═╧═ 🏁  Execução terminada ⏱  4ms  ═══
Jogo do Galo
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
│ P1(ALGORITMO): MiniMax | P2(NIVEL_DEBUG): COMPLETO | P3(SEMENTE): 1 | P4(LIMITE_TEMPO): 10
...
└──────────────────────────────────────────────────────────────────────
 ...
 │   A B C
┌─ ⚖  Indicadores ─────────────────────────────────────────────────────
│ I1(IND_CUSTO): 0 | I2(Tempo(ms)): 4 | I3(Iterações): 19 | I4(IND_EXPANSOES): 6 |
...
═╤═ ►  Execução iniciada ═══
 ...
 │      A B C
 │    💾 0
 ├─ ⚙️  Parâmetros ─ P1=2 P2=4 P3=1 P4=10 P5=0 P6=1 P7=3 P8=1 P11=0 P12=2 P13=0 P14=0
═╧═ 🏁  Execução terminada ⏱  7ms  ═══
Jogo do Galo
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
│ P1(ALGORITMO): MiniMax alfa/beta | P2(NIVEL_DEBUG): COMPLETO | P3(SEMENTE): 1
...
└──────────────────────────────────────────────────────────────────────
 ...
 │   A B C
┌─ ⚖  Indicadores ─────────────────────────────────────────────────────
│ I1(IND_CUSTO): 0 | I2(Tempo(ms)): 7 | I3(Iterações): 10 | I4(IND_EXPANSOES): 4 |
│ I5(IND_GERACOES): 33 | I6(IND_LOWER_BOUND): 0
└──────────────────────────────────────────────────────────────────────
...
Opção:
</pre>
...
└──────────────────────────────────────────────────────────────────────
 ...
 │   A B C
┌─ ⚖  Indicadores ─────────────────────────────────────────────────────
│ I1(IND_CUSTO): 0 | I2(Tempo(ms)): 1 | I3(Iterações): 9 | I4(IND_EXPANSOES): 4 |
│ I5(IND_GERACOES): 9 | I6(IND_LOWER_BOUND): 0
└──────────────────────────────────────────────────────────────────────
...
Opção:
...
═╤═ ►  Execução iniciada ═══
 ├─ ⚙️  Parâmetros ─ P1=1 P2=0 P3=1 P4=10 P5=0 P6=4 P7=20 P8=1 P11=0 P12=0 P13=0 P14=0
═╧═ 🏁  Execução terminada ⏱  136ms  ═══
Jogo do Galo
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
│ P1(ALGORITMO): MiniMax | P2(NIVEL_DEBUG): NADA | P3(SEMENTE): 1 | P4(LIMITE_TEMPO): 10
│ P5(LIMITE_ITERACOES): 0 | P6(VER_ACOES): 4 | P7(LIMITE): 20 | P8(ESTADOS_REPETIDOS): ignorar
│ P11(BARALHAR_SUCESSORES): 0 | P12(ORDENAR_SUCESSORES): 0 | P13(PODA_HEURISTICA): 0
│ P14(PODA_CEGA): 0
└──────────────────────────────────────────────────────────────────────
 ├■  A B C
 ...
 ├■  A B C
┌─ ⚖  Indicadores ─────────────────────────────────────────────────────
│ I1(IND_CUSTO): 0 | I2(Tempo(ms)): 136 | I3(Iterações): 113416 | I4(IND_EXPANSOES): 155758 |
│ I5(IND_GERACOES): 318517 | I6(IND_LOWER_BOUND): 0
└──────────────────────────────────────────────────────────────────────
...
Opção:
</pre>
...
═╤═ ►  Execução iniciada ═══
 ├─ ⚙️  Parâmetros ─ P1=1 P2=0 P3=1 P4=10 P5=0 P6=4 P7=20 P8=1 P11=0 P12=2 P13=0 P14=0
═╧═ 🏁  Execução terminada ⏱  41ms  ═══
Jogo do Galo
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
│ P1(ALGORITMO): MiniMax | P2(NIVEL_DEBUG): NADA | P3(SEMENTE): 1 | P4(LIMITE_TEMPO): 10
│ P5(LIMITE_ITERACOES): 0 | P6(VER_ACOES): 4 | P7(LIMITE): 20 | P8(ESTADOS_REPETIDOS): ignorar
...
└──────────────────────────────────────────────────────────────────────
 ...
 └■  A B C
┌─ ⚖  Indicadores ─────────────────────────────────────────────────────
│ I1(IND_CUSTO): 0 | I2(Tempo(ms)): 41 | I3(Iterações): 826 | I4(IND_EXPANSOES): 624 |
│ I5(IND_GERACOES): 2299 | I6(IND_LOWER_BOUND): 0
└──────────────────────────────────────────────────────────────────────
...
Opção:
</pre>
...
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
│ P1(ALGORITMO): MiniMax alfa/beta | P2(NIVEL_DEBUG): NADA | P3(SEMENTE): 1
│ P4(LIMITE_TEMPO): 10 | P5(LIMITE_ITERACOES): 0 | P6(VER_ACOES): 4 | P7(LIMITE): 20
│ P8(ESTADOS_REPETIDOS): ignorar | P11(BARALHAR_SUCESSORES): 0 | P12(ORDENAR_SUCESSORES): 0
│ P13(PODA_HEURISTICA): 0 | P14(PODA_CEGA): 0
└──────────────────────────────────────────────────────────────────────
 ├□  A B C
 ├□1 x . . 1
 ...
 ├□  A B C
┌─ ⚖  Indicadores ─────────────────────────────────────────────────────
│ I1(IND_CUSTO): 0 | I2(Tempo(ms)): 11 | I3(Iterações): 7848 | I4(IND_EXPANSOES): 11750 |
│ I5(IND_GERACOES): 27362 | I6(IND_LOWER_BOUND): 0
└──────────────────────────────────────────────────────────────────────
...
Opção:
</pre>
...
═╤═ ►  Execução iniciada ═══
 ├─ ⚙️  Parâmetros ─ P1=2 P2=0 P3=1 P4=10 P5=0 P6=4 P7=20 P8=1 P11=0 P12=2 P13=0 P14=0
═╧═ 🏁  Execução terminada ⏱  34ms  ═══
Jogo do Galo
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
│ P1(ALGORITMO): MiniMax alfa/beta | P2(NIVEL_DEBUG): NADA | P3(SEMENTE): 1
│ P4(LIMITE_TEMPO): 10 | P5(LIMITE_ITERACOES): 0 | P6(VER_ACOES): 4 | P7(LIMITE): 20
...
└──────────────────────────────────────────────────────────────────────
 ...
 └■  A B C
┌─ ⚖  Indicadores ─────────────────────────────────────────────────────
│ I1(IND_CUSTO): 0 | I2(Tempo(ms)): 34 | I3(Iterações): 700 | I4(IND_EXPANSOES): 425 |
│ I5(IND_GERACOES): 1465 | I6(IND_LOWER_BOUND): 0
└──────────────────────────────────────────────────────────────────────
...
Opção:
</pre>
...
Introduza após arrancar:  **1; 3; 1; 2; 2; 2; 7; 20; 12; 2; *ENTER*; 6.**
...
═╤═ ►  Execução iniciada ═══
 ...
 ├─ ⚙️  Parâmetros ─ P1=2 P2=2 P3=1 P4=10 P5=0 P6=4 P7=20 P8=1 P11=0 P12=2 P13=0 P14=0
═╧═ 🏁  Execução terminada ⏱  29ms  ═══
Jogo do Galo
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
│ P1(ALGORITMO): MiniMax alfa/beta | P2(NIVEL_DEBUG): PASSOS | P3(SEMENTE): 1
│ P4(LIMITE_TEMPO): 10 | P5(LIMITE_ITERACOES): 0 | P6(VER_ACOES): 4 | P7(LIMITE): 20
│ P8(ESTADOS_REPETIDOS): ignorar | P11(BARALHAR_SUCESSORES): 0 | P12(ORDENAR_SUCESSORES): 2
│ P13(PODA_HEURISTICA): 0 | P14(PODA_CEGA): 0
└──────────────────────────────────────────────────────────────────────
 ...
 │   A B C
┌─ ⚖  Indicadores ─────────────────────────────────────────────────────
│ I1(IND_CUSTO): 0 | I2(Tempo(ms)): 29 | I3(Iterações): 700 | I4(IND_EXPANSOES): 425 |
│ I5(IND_GERACOES): 1465 | I6(IND_LOWER_BOUND): 0
└──────────────────────────────────────────────────────────────────────
...
Opção:
