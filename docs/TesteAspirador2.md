...
═╤═ ►  Execução iniciada ═══
 ...
 │        * [.]
 │       🍃🪜
 ├─ ⚙️  Parâmetros ─ P1=3 P2=4 P3=1 P4=10 P5=0 P6=1 P7=3 P8=1 P11=0
═╧═ 🏁  Execução terminada ⏱   ═══
Aspirador
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
...
═╤═ ►  Execução iniciada ═══
 ...
 │  │  └─ { 🔖4 }
 │  └─ { 🔖2 }
 ├─ ⚙️  Parâmetros ─ P1=3 P2=3 P3=1 P4=10 P5=0 P6=4 P7=10 P8=1 P11=0
═╧═ 🏁  Execução terminada ⏱   ═══
Aspirador
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
...
Opção:
```
Com o nível debug a 3 e ver ações a 4, vemos a árvore de procura sem os estados, apenas as ações. 
A informação é mais reduzida, mas poderá ser uma boa forma de analisar e ver a árvore,
o que com a informação dos estados poderia já não ser possível.
...
═╤═ ►  Execução iniciada ═══
 ...
 │     │     🎯 Solução encontrada!
 │     │    [.] .  ─── 🎯 3 → 📈 ───  { 🔖18 }
 ├─ ⚙️  Parâmetros ─ P1=3 P2=2 P3=1 P4=10 P5=0 P6=4 P7=0 P8=1 P11=0
═╧═ 🏁  Execução terminada ⏱   ═══
Aspirador
┌─ ⚙️  Parâmetros ─────────────────────────────────────────────────────
