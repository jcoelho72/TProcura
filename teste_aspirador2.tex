...
Execução de exemplo com base no problema do Aspirador. Selecione o projeto \doxylink{classTProcuraConstrutiva}{TProcura\+Construtiva}, e execute. Pode acompanhar o teste excutando as ações localmente.\hypertarget{teste_aspirador2_autotoc_md35}{}\doxysubsection{\texorpdfstring{Sumário}{Sumário}}\label{teste_aspirador2_autotoc_md35}
