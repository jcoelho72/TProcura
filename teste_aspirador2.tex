...
Execução de exemplo com base no problema do Aspirador. Selecione o projeto \doxylink{classTProcuraConstrutiva}{TProcura\+Construtiva}, e execute. Pode acompanhar o teste excutando as ações localmente.\hypertarget{teste_aspirador2_autotoc_md26}{}\doxysubsection{\texorpdfstring{Sumário}{Sumário}}\label{teste_aspirador2_autotoc_md26}
...
\hypertarget{teste_aspirador2_autotoc_md27}{}\doxysubsection{\texorpdfstring{Ação 10 -\/ Procura em Profundidade}{Ação 10 - Procura em Profundidade}}\label{teste_aspirador2_autotoc_md27}
...
\hypertarget{teste_aspirador2_autotoc_md28}{}\doxysubsection{\texorpdfstring{Ação 11 -\/ Efetuar uma procura em Profundidade Primeiro}{Ação 11 - Efetuar uma procura em Profundidade Primeiro}}\label{teste_aspirador2_autotoc_md28}
...
\hypertarget{teste_aspirador2_autotoc_md29}{}\doxysubsection{\texorpdfstring{Ação 12 -\/ Ver uma árvore de procura maior}{Ação 12 - Ver uma árvore de procura maior}}\label{teste_aspirador2_autotoc_md29}
...
\hypertarget{teste_aspirador2_autotoc_md30}{}\doxysubsection{\texorpdfstring{Ação 13 -\/ Profundidade Iterativa}{Ação 13 - Profundidade Iterativa}}\label{teste_aspirador2_autotoc_md30}
...
\hypertarget{teste_aspirador2_autotoc_md31}{}\doxysubsection{\texorpdfstring{Ação 14 -\/ Profundidade ilimitada}{Ação 14 - Profundidade ilimitada}}\label{teste_aspirador2_autotoc_md31}
...
\hypertarget{teste_aspirador2_autotoc_md32}{}\doxysubsection{\texorpdfstring{Ação 15 -\/ Desafio Procura Profundidade}{Ação 15 - Desafio Procura Profundidade}}\label{teste_aspirador2_autotoc_md32}
