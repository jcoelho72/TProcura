...
# esforço A
srun bin/MPI/TProcuraConstrutiva 2:200:20 -R Resultados/particao_1 -M 1 -P P1=3 P2=4 P7=-1 P3=1 x P8=1,3

# esforço B
srun bin/MPI/TProcuraConstrutiva 2:200:20 -R Resultados/particao_1B -M 1 -P P1=3 P2=4 P7=-1 P3=1:10 x P8=1,3

# esforço C
srun bin/MPI/TProcuraConstrutiva 2:200:20 -R Resultados/particao_1C -M 1 -P P1=2 P2=4 P7=-1 P3=1:100 x P8=1,3
