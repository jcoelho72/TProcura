...
Execução de exemplo com base no problema da Partição. Selecione o projeto \doxylink{classTProcuraConstrutiva}{TProcura\+Construtiva}, e execute. Pode acompanhar o teste excutando as ações localmente.\hypertarget{teste_particao_autotoc_md49}{}\doxysubsection{\texorpdfstring{Sumário}{Sumário}}\label{teste_particao_autotoc_md49}
...
\hypertarget{teste_particao_autotoc_md50}{}\doxysubsection{\texorpdfstring{Ação 1 -\/ Ver instâncias}{Ação 1 - Ver instâncias}}\label{teste_particao_autotoc_md50}
...
\hypertarget{teste_particao_autotoc_md51}{}\doxysubsection{\texorpdfstring{Ação 2 -\/ Resolver manualmente}{Ação 2 - Resolver manualmente}}\label{teste_particao_autotoc_md51}
...
\hypertarget{teste_particao_autotoc_md52}{}\doxysubsection{\texorpdfstring{Ação 3 -\/ Testes Empíricos}{Ação 3 - Testes Empíricos}}\label{teste_particao_autotoc_md52}
