...
Execução de exemplo com base no problema da Partição. Selecione o projeto \doxylink{classTProcuraConstrutiva}{TProcura\+Construtiva}, e execute. Pode acompanhar o teste excutando as ações localmente.\hypertarget{teste_particao_autotoc_md42}{}\doxysubsection{\texorpdfstring{Sumário}{Sumário}}\label{teste_particao_autotoc_md42}
...
\DoxyCodeLine{PS\ C:\(\backslash\)Work\(\backslash\)Git\(\backslash\)TProcura\(\backslash\)Construtiva\(\backslash\)Teste>\ ../../x64/Release/TProcuraConstrutiva\ -\/h}
\DoxyCodeLine{}
\DoxyCodeLine{Teste\ TProcurasConstrutivas}
\DoxyCodeLine{Problema:}
\DoxyCodeLine{\ \ 1\ -\/\ Aspirador}
