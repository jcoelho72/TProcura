...
# esforço A
srun ./bin/mpi/TProcura 1 -R Resultados/tvetor_2mo -M 0 -P P2=3 "P1=1:12" x "P6=1:3" x "P3=1:10"
srun ./bin/mpi/TProcura 1 -R Resultados/tvetor_2 -M 1 -P P2=3 "P1=1:12" x "P6=1:3" x "P3=1:10"

# esforço B
srun ./bin/mpi/TProcura "1:4" -R Resultados/tvetor_2Bmo -M 0 -P P2=3 "P1=1:12" x "P6=1:3" x "P3=1:10"
srun ./bin/mpi/TProcura "1:4" -R Resultados/tvetor_2B -M 1 -P P2=3 "P1=1:12" x "P6=1:3" x "P3=1:10"

# esforço C
srun ./bin/mpi/TProcura "1:10" -R Resultados/tvetor_2C -M 1 -P P2=3 "P1=1:12" x "P6=1:3" x "P3=1:10"
