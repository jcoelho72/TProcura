...
Execução de exemplo com base no problema da Partição, com codificação binária. Selecione o projeto \doxylink{classTProcuraConstrutiva}{TProcura\+Construtiva}, e execute. Pode acompanhar o teste excutando as ações localmente.\hypertarget{teste_particao_cb_autotoc_md53}{}\doxysubsection{\texorpdfstring{Sumário}{Sumário}}\label{teste_particao_cb_autotoc_md53}
